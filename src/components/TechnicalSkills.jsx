...
import {
  SiTailwindcss, SiPandas, SiCplusplus, SiNumpy, SiMongodb,
  SiExpress, SiPostman, SiLinux, SiTableau, SiPowerbi,
  SiAdobeillustrator, SiAdobephotoshop, SiMicrosoftexcel
} from 'react-icons/si';
import { BiData } from 'react-icons/bi';
import { DiScrum } from 'react-icons/di';
import { useEffect, useState } from 'react';
...
const TechnicalSkills = () => {
  ...
  const skills = [
    ...
    { icon: SiMicrosoftexcel, name: 'MS Excel', category: 'Data Analysis' },
    { icon: SiAdobeillustrator, name: 'Illustrator', category: 'Graphic Design' },
    { icon: SiAdobephotoshop, name: 'Photoshop', category: 'Graphic Design' },
    { icon: FaJava, name: 'Java', category: 'Programming' },
    { icon: FaAndroid, name: 'Android Development', category: 'Mobile Development' },
  ];
